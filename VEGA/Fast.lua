...
photo = "https://t.me/ghgghghghg/9"
local list = Redis:smembers(Fast.."totaui")
local JABWA = "*✧ عدد مشتركين بوتك『 "..#list.." 』مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'اضغط هنا للدخول للصانع', url = 't.me/VEGA_MAKER_bot '},
},
}
...
send(msg.chat_id,msg.id,"*⚡ مرحبا اليك قسم صانع الحمايه 🚀\n\n⚡ قناة التحديثات (@SOURCEVEGA) 🚀\n\n⚡ جروب الدعم (@VIP_KIMY) 🚀\n\n⚡ المطور زومبي (@Zo_Mbi_e) 🚀*","md",true, false, false, true, reply_markup)
return false 
end
if text == '✧ طريقة صنع بوت' or text == 'مش شغال' or text == 'عاوز اعمل بوت' or text == 'عاوزه اعمل بوت' then
video = "https://t.me/SOURCEVEGA/3143"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰

♻️⁩طريقه انشاء بوت من الصفر •
...
معرف الصانع (@VEGA_MAKER_bot) •

اوامر بوت فازر ↑↓

- (https://t.me/SOURCEVEGA/1009)
...
if text == '⦁ طريقة صنع بوت' or text == 'مش شغال' or text == 'عاوز اعمل بوت' or text == 'عاوزه اعمل بوت' then
video = "https://t.me/SOURCEVEGA/4613"
local T =[[*
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
...
photo = "https://t.me/ghgghghghg/10"
local T =[[
 [𝐖𝐄l𝐂𝐎𝐌𝐄 𝐓𝐎 𝐒𝐎𝗨𝐑𝐂𝐄 𝐕𝐄𝐆𝐀  •](t.me/SOURCEVEGA )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'زومبي' or text == '• مبرمج السورس' or text == '✧ مبرمج السورس' then  
local UserId_Info = bot.searchPublicChat("JABWA")
...
local TestText = "*▷ 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹 ZoMBie  🖤\n▷ 𝑵𝑨𝑴𝑬 ▹* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*▷ 𝑩𝑰𝑶 ▹ "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/SOURCEVEGA"}
},
}
...
keyboard.inline_keyboard = {
{
{text = Text, url = 't.me/VEGA_MAKER_bot '},
},
}
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(JABWA).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
